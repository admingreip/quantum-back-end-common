...
public class UtlValidation {
	...
	/*
	 * Devuelve true si la cadena tiene silo un numero entero con o sin signo, de lo
	...
	/*
	 * Devuelve true si la cadena tiene un numero entero o real con o sin signo, de
	...
	/*
	 * Devuelve true si la cadena tiene un numero entero o real, de lo contrario
	 * devuelve false.
	 */
