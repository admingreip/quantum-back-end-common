...
public class UtlNumber {
	...
	public static BigDecimal dividir(Long dividendo, Long divisor, int precision) {
		BigDecimal v = BigDecimal.valueOf(dividendo).divide(BigDecimal.valueOf(divisor), precision,
	...
	public static BigDecimal prorrateo(BigDecimal aProrratear, BigDecimal dividendo, BigDecimal divisor,
			int precision) {
	 ...
	 */
	public static String convertNumberToLetter(double doubleNumber, String descMoneda) throws NumberFormatException {
	...
	public static String convertNumberToLetter(Float number, String moneda) throws NumberFormatException {
		String converted = new String();
